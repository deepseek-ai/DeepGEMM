...
namespace deep_gemm::sched::nvfp4 {
...
DG_STATIC_ASSERT(sizeof(sched::nvfp4::TaskInfo<true>) == sizeof(sched::nvfp4::TaskInfo<false>), "Invalid layout");
...
struct MegaMoEScheduler {
    ...
    // Workspace
    const layout::nv_moe::Workspace& workspace;
    ...
    CUTLASS_DEVICE explicit MegaMoEScheduler(const layout::nv_moe::Workspace& workspace):
        workspace(workspace) {}

    CUTLASS_DEVICE MegaMoEScheduler(const layout::nv_moe::Workspace& workspace,
